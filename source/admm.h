...
namespace spm {
    ...
    Vector admm_minimize_mp(const PVector & green, const PGrid &grid, const SPM_settings &settings);
    Vector admm_minimize_mp(const PVector & green, const PGrid &grid, const SPM_settings &settings, PScalar lambda);
