...
def Compare2():
    ...
    omegas, spectral = GetSpectral("../results/f12h0_spec_2000.h5")
    ax_s.plot(omegas, spectral, label="β = 1.2 2")
    omegas, spectral = GetSpectral("../results/f16h0_spec_2000.h5")
    ax_s.plot(omegas, spectral, label="β = 1.635 2")
    omegas, spectral = GetSpectral("../results/f12h0_spec_1000.h5")
    ax_s.plot(omegas, spectral, label="β = 1.2 1")
    omegas, spectral = GetSpectral("../results/f16h0_spec_1000.h5")
    ax_s.plot(omegas, spectral, label="β = 1.635 1")
    ax_s.legend()

    fig_g, ax_g = plt.subplots()
    taus, green, green_rc = GetGreen("../results/f12h0_spec_2000.h5")
    ax_g.plot(green_rc, label="β = 1.2 2")
    ax_g.plot(green, label="β = 1.2")
    taus, green, green_rc = GetGreen("../results/f12h0_spec_1000.h5")
    ax_g.plot(green_rc, label="β = 1.2 1")
    taus, green, green_rc = GetGreen("../results/f16h0_spec_2000.h5")
    ax_g.plot(green_rc, label="β = 1.635 2")
    ax_g.plot(green, label="β = 1.635")
    taus, green, green_rc = GetGreen("../results/f16h0_spec_1000.h5")
    ax_g.plot(green_rc, label="β = 1.635 1")
    ax_g.legend()
def Compare():
    fig_s, ax_s = plt.subplots()
    omegas, spectral = GetSpectral("../results/f12h0_spec_2000.h5")
    ax_s.plot(omegas, spectral, label="β = 1.2")
    #omegas, spectral = GetSpectral("../results/f14h0_spec_2000.h5")
    #ax_s.plot(omegas, spectral, label="β = 1.423")
    omegas, spectral = GetSpectral("../results/f16h0_spec_2000.h5")
    ax_s.plot(omegas, spectral, label="β = 1.635")
    #omegas, spectral = GetSpectral("../results/f17h0_spec_2000.h5")
    #ax_s.plot(omegas, spectral, label="β = 1.75")
    #omegas, spectral = GetSpectral("../results/f18h0_spec_2000.h5")
    ...
    #taus, green, green_rc = GetGreen("../results/f14h0_spec_2000.h5")
    #ax_g.plot(green_rc/green - 1, label="β = 1.423")
    taus, green, green_rc = GetGreen("../results/f16h0_spec_2000.h5")
    ax_g.plot(green_rc/green - 1, label="β = 1.635")
    #taus, green, green_rc = GetGreen("../results/f17h0_spec_2000.h5")
    #ax_g.plot(green_rc/green - 1, label="β = 1.75")
    #taus, green, green_rc = GetGreen("../results/f18h0_spec_2000.h5")
    #ax_g.plot(green_rc/green - 1, label="β = 1.85")
    ax_g.legend()


#PlotSpectralRun("../results/f12h0_spec_2000.h5")
Compare2()
plt.show()
